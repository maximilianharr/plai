...
class YOLO:
    def __init__(self, obj_threshold, nms_threshold, yolo_h5_file):
        """Init.
        ...
        if os.path.exists(yolo_h5_file):
            self._yolo = load_model(yolo_h5_file)
        elif os.path.exists('yolo/data/yolo.h5'):
            self._yolo = load_model('yolo/data/yolo.h5')
        else:
